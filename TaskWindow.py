...
class TaskWindow(QWidget):
    def __init__(self, folder_path):
        ...
        if self.meta:
            self.ax, self.ay, self.awidth, self.aheight = map(int, self.meta.split(self.META_DELIMITER))
    ...
    def save_meta(self):
        ...
        with open(os.path.join(self.FILE_LOCATION, self.META_DATA), "w") as file:
            file.write(f"{self.ax}{self.META_DELIMITER}{self.ay}{self.META_DELIMITER}{self.awidth}{self.META_DELIMITER}{self.aheight}")
